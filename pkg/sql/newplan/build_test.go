...
func Test_build16_q15(t *testing.T) {
	convey.Convey("tpch-q15", t, func() {
		sql := `with q15_revenue0 as (
					select
...
func Test_build16_q16(t *testing.T) {
	convey.Convey("tpch-q16", t, func() {
		sql := `select
					p_brand,
					p_type,
					p_size,
...
func Test_build16_q22(t *testing.T) {
	convey.Convey("tpch-q22", t, func() {
		sql := `
				select
					cntrycode,
					count(*) as numcust,
