...
func (m *RequestLabel) Reset()         { *m = RequestLabel{} }
func (m *RequestLabel) String() string { return proto.CompactTextString(m) }
...
func (m *RequestLabel) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestLabel.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *RequestLabel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestLabel.Merge(m, src)
}
func (m *RequestLabel) XXX_Size() int {
	return m.Size()
}
func (m *RequestLabel) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestLabel.DiscardUnknown(m)
}

var xxx_messageInfo_RequestLabel proto.InternalMessageInfo
...
type ProxyInfo struct {
	RequestLabel         *RequestLabel          `protobuf:"bytes,1,opt,name=RequestLabel,proto3" json:"RequestLabel,omitempty"`
	ConfigData           *logservice.ConfigData `protobuf:"bytes,2,opt,name=ConfigData,proto3" json:"ConfigData,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *ProxyInfo) GetRequestLabel() *RequestLabel {
	if m != nil {
...
func (m *ProxyInfo) GetConfigData() *logservice.ConfigData {
	if m != nil {
		return m.ConfigData
	}
	return nil
...
func init() {
	proto.RegisterType((*RequestLabel)(nil), "proxy.RequestLabel")
	proto.RegisterMapType((map[string]string)(nil), "proxy.RequestLabel.LabelsEntry")
	proto.RegisterType((*ProxyInfo)(nil), "proxy.ProxyInfo")
}
...
var fileDescriptor_700b50b08ed8dbaf = []byte{
	...
	0xa8, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x73, 0xa4, 0x04, 0x72, 0xf2, 0xd3,
	0x8b, 0x53, 0x8b, 0xca, 0x32, 0x93, 0x53, 0x21, 0x12, 0x4a, 0x4d, 0x8c, 0x5c, 0x3c, 0x41, 0xa9,
	0x85, 0xa5, 0xa9, 0xc5, 0x25, 0x3e, 0x89, 0x49, 0xa9, 0x39, 0x42, 0xe6, 0x5c, 0x6c, 0x39, 0x20,
	0x46, 0xb1, 0x04, 0xa3, 0x02, 0xb3, 0x06, 0xb7, 0x91, 0xbc, 0x1e, 0xc4, 0x1c, 0x64, 0x45, 0x7a,
	0x60, 0xb2, 0xd8, 0x35, 0xaf, 0xa4, 0xa8, 0x32, 0x08, 0xaa, 0x5c, 0xca, 0x92, 0x8b, 0x1b, 0x49,
	...
	,
}
...
func (m *ProxyInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RequestLabel != nil {
		{
			size, err := m.RequestLabel.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestLabel) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: RequestLabel: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestLabel: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ProxyInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RequestLabel == nil {
				m.RequestLabel = &RequestLabel{}
			}
			if err := m.RequestLabel.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if m.ConfigData == nil {
				m.ConfigData = &logservice.ConfigData{}
			}
